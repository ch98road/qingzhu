...
public class UploadImageServiceImpl implements  UploadImageService{
    ...
    private void init() {
        ...
        auth = Auth.create(CloudStorageConfig.getQiniuAccessKey( ), CloudStorageConfig.getQiniuSecretKey( ));
        // 根据命名空间生成的上传token
        token = auth.uploadToken(CloudStorageConfig.getQiniuBucketName( ));
    }
    ...
    public String uploadQNImg(FileInputStream file, String key) {
        try {
            ...
            String path = CloudStorageConfig.getQiniuDomain( ) + "/" + putRet.key;
